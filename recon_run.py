"""Reconstruct an MCGPU-PET run (span=1) with mirror-symmetrized MLEM.
"""
...
from draw_tools import plot3Dimage
...
plot3Dimage(x, "img/recon_mlem_trues_20.png")
